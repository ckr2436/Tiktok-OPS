...
class OpenAIWhisperJob(Base):
    ...
    do_subtitle: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("1"))
    do_contact_sheet: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("0"))
    do_download_only: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default=text("0"))
    contact_interval: Mapped[float | None] = mapped_column(default=None)
    subtitle_status: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'pending'"))
    contact_sheet_status: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'skipped'"))
    download_status: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'skipped'"))
    subtitle_error: Mapped[str | None] = mapped_column(Text, default=None)
    contact_sheet_error: Mapped[str | None] = mapped_column(Text, default=None)
    download_error: Mapped[str | None] = mapped_column(Text, default=None)
