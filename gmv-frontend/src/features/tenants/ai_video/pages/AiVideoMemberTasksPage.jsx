...
import { aiVideoTaskStatus } from '../taskPresentation.js'
              ...
              <tbody>
                ...
                {items.map((task) => (
                  <tr key={task.id}>
                    ...
                    <td>
                      <Badge type={statusType(task.state)}>{aiVideoTaskStatus(task).label}</Badge>
                    </td>
          ...
          <section style={{ marginTop: 20, borderTop: '1px solid var(--border)', paddingTop: 16 }}>
            ...
            {detailQuery.isLoading ? (
              ...
              <div style={{ marginTop: 12, display: 'grid', gap: 8 }}>
                ...
                <div>
                  <strong>状态：</strong> <Badge type={statusType(detail?.state)}>{aiVideoTaskStatus(detail).label}</Badge>
                </div>
